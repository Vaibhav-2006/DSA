// Should actually be done with a proper stack array with proper functions like pop and push.
           ...
           int n2, int n3)
{
    ...
    // of stack..
    //Here top is taken as index 0 which is in fact not correct as top is always at end of stack array
    //and so the insertion would be O(1) but now in this stack insetion is O(N).
    //Just look at the approach used here.
